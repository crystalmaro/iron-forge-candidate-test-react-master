...
const DealershipInventoryActivityController:React.FC<Props> = ({ children }) => {
  ...
  const {
    ...
    dealership,
    vehicleTypeList,
  } = dataService.useDealershipInventoryActivityControllerQuery({ selectedVehicleType, searchKey });
...
export default DealershipInventoryActivityController;
